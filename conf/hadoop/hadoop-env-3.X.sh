...
# export HADOOP_OPTIONAL_TOOLS="hadoop-azure-datalake,hadoop-aws,hadoop-kafka,hadoop-openstack,hadoop-azure"
...
# export HADOOP_WORKERS="${HADOOP_CONF_DIR}/slaves"
...
# this is the default:
export HADOOP_NAMENODE_OPTS="-XmxHADOOP_NAMENODE_HEAP_MAXm -Dhadoop.security.logger=${HADOOP_SECURITY_LOGGER:-INFO,RFAS} $HADOOP_NAMENODE_OPTS"
...
#
# This is the default:
export HADOOP_SECONDARYNAMENODE_OPTS="-Dhadoop.security.logger=INFO,RFAS $HADOOP_SECONDARYNAMENODE_OPTS"
